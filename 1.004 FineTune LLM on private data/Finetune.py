...
# 658.7266 seconds used for training.
# 10.98 minutes used for training.
# Peak reserved memory = 3.305 GB.
# Peak reserved memory for training = 0.883 GB.
# Peak reserved memory % of max memory = 86.723 %.
# Peak reserved memory for training % of max memory = 23.17 %.
